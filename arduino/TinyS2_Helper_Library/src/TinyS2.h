...
// March 9, 2026 - Seon Rozenblum (Unexpected Maker)
//
...
#else
                    rmt_data[index].level0 = 1;
                    rmt_data[index].duration0 = 8; // 800ns @ 10MHz
                    rmt_data[index].level1 = 0;
                    rmt_data[index].duration1 = 4; // 400ns @ 10MHz
                }
                else
                {
                    rmt_data[index].level0 = 1;
                    rmt_data[index].duration0 = 4; // 400ns @ 10MHz
                    rmt_data[index].level1 = 0;
                    rmt_data[index].duration1 = 8; // 800ns @ 10MHz
#endif
                }
                index++;
            }
